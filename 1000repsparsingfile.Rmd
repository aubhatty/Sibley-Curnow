...
X10000 <- read_delim("/Users/abuzarbhatty/Downloads/10000pop (1).csv",delim = "\t", escape_double = FALSE,  col_types = cols(cycle = col_character(),  count_p1 = col_number(), count_p2 = col_number()),  trim_ws = TRUE) #loads desired file from workstation and sets up file to be parsed, have to specify file path for file to load
